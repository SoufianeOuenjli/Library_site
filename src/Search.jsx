...
function Search({searchTerm, setSearchTerm, categories,setCategories}) {
    ...
    return (
      <>
        <div className="input-group mb-4">
            ...
            <input type="text" onChange={(e)=>setSearchTerm(e.target.value)} className="form-control" placeholder="Search for a book..." aria-label="Search" aria-describedby="basic-addon1" />
        </div>
      </>
    )
  }
